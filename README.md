...
> **Démarre un projet Claude Code + Claude Design en 2 minutes.** Réponds à 9 questions, télécharge un `.zip` prêt à l'emploi. Gratuit, open source, MIT.
...
![Cordée.IA generator — 9-step questionnaire with live preview of the generated zip](docs/screenshots/generator.png)
...
Cordée.IA fait ce travail à ta place. Tu réponds à 9 questions, tu cliques
...
1. L'utilisateur répond à 9 questions (nom, mode, stack, agents, skills, MCPs, design).
